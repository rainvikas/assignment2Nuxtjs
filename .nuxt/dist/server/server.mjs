...
const __vite_ssr_import_2__ = await __vite_ssr_import__("/pages/mainform.vue?macro=true");

const __vite_ssr_import_3__ = await __vite_ssr_import__("/pages/mainform2.vue?macro=true");

const __vite_ssr_import_4__ = await __vite_ssr_import__("/pages/productform.vue?macro=true");
...
const _sfc_main = {
    ...
    data() {
        return {
            myarr: [],
            mobiles: ["Apple Iphone", "Samsung", "OnePlus", "Hauvei"],
            shoes : ["nike","puma","red-chief","bata"],
            earphones :["boat","Apple Air-pod","Oneplus Buds","Wired earphones"],
            watches : ["titan","G-shock","Rolex","Fossil"],
            showMobile: false,
            showShoe: false,
            earPhone :  false,
            showWatch : false,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (this.showMobile==true) {
    ...
    __vite_ssr_import_0__.ssrRenderList(this.mobiles, (items) => {
      _push(`<div class=""><div class="">${__vite_ssr_import_0__.ssrInterpolate(items)}</div></div>`)
    })
    _push(`<!--]--></div>`)
  } else {
    _push(`<!---->`)
  }
  if (this.showShoe==true) {
    _push(`<div><!--[-->`)
    __vite_ssr_import_0__.ssrRenderList(this.shoes, (items) => {
      _push(`<div class=""><div class="">${__vite_ssr_import_0__.ssrInterpolate(items)}</div></div>`)
    })
    _push(`<!--]--></div>`)
  } else {
  ...
  if (this.earPhone==true) {
    _push(`<div><!--[-->`)
    __vite_ssr_import_0__.ssrRenderList(this.earphones, (items) => {
      _push(`<div class=""><div class="">${__vite_ssr_import_0__.ssrInterpolate(items)}</div></div>`)
    })
    _push(`<!--]--></div>`)
  } else {
  ...
  if (this.showWatch==true) {
    _push(`<div><!--[-->`)
    __vite_ssr_import_0__.ssrRenderList(this.watches, (items) => {
      _push(`<div class=""><div class="">${__vite_ssr_import_0__.ssrInterpolate(items)}</div></div>`)
    })
    _push(`<!--]--></div>`)
  } else {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${__vite_ssr_import_1__.ssrRenderAttrs(__vite_ssr_import_0__.mergeProps({ class: "content bg-slate-300" }, _attrs))}><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/all.min.css" integrity="sha512-1sCRPdkRXhBV2PBLUdRb4tMg1w2YPf37qatUFeS7zlBy7jJI8Lf4VHwWfZZfpXtYSLy85pkm9GaYVYMfw5BC1A==" crossorigin="anonymous" referrerpolicy="no-referrer"><h1 class="text-center font-extrabold text-5xl mt-8 bg-blue-200">Shopping Product List</h1><nav class="text-center font-bold text-xl mt-8"><a><select name="Category" id="watches" class="bg-gray-300"><option value="watch">Select Watches</option><option value="watch">Titan</option><option value="watch">Puma</option><option value="watch">Ladies Wear</option><option value="watch">G-Shock</option><option value="watch">Rolex</option></select><select name="Category" id="mobile" class="bg-gray-300"><option value="mobile">Select Mobiles</option><option value="mobile">Apple Iphone</option><option value="mobile">Oneplus</option><option value="mobile">Oppo</option><option value="mobile">Vivo</option><option value="mobile">Redmi</option><option value="mobile">Samsung</option></select><select name="Category" id="earphone" class="bg-gray-300"><option value="earphone">Select Earphone</option><option value="earphone">Apple Airpods</option><option value="earphone">Oneplus Buds</option><option value="earphone">Oppo Earphone</option><option value="earphone">Vivo Earphones</option><option value="earphone">Redmi Earphone</option><option value="earphone">Samsung Earphones</option></select><select name="Category" id="shoes" class="bg-gray-300"><option value="shoes">Select Shoes</option><option value="shoes">Formal Shoes</option><option value="shoes">Casual Shoes</option><option value="shoes">Nike Air</option><option value="shoes">Puma Sports</option><option value="shoes">Red Chief Leather</option><option value="shoes">Loafers</option></select><br><div class="inline-flex p-4 mt-4"><div class="mr-8 border-2 px-2 border-black rounded-md"><a href="productform">Add Products</a></div><div class="ml-8 border-2 px-2 border-black rounded-md"><a href="mainform2">Shoe Category</a></div></div></a></nav><div><table class="mt-6"><tr class="border-2 rounded-md border-black"><td class="text-center p-2"><div><img src="assets/show1.jfif" alt="showimage" class="px-64 items-center"><h3 class="font-bold text-xl">Shoes</h3><p><b>This is Demo Show of Nike Brand</b></p><h5><b>Rs 10,000/- only</b></h5><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><br><button class="buy-1 border-2 px-2 border-black rounded-md">Buy Now</button></div></td><td class="p-2"><div class="content text-center"><img src="assets/show2.jfif" alt="showimage" class="px-64 items-center"><h3 class="font-bold text-xl">Shoes</h3><p><b>This is 2nd Demo Show of Nike Brand</b></p><h5><b>Rs 11,200/- only</b></h5><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><br><button class="buy-2 border-2 px-2 border-black rounded-md">Buy Now</button></div></td></tr><tr class="border-2 rounded-md border-black"><td class="p-2"><div class="content text-center"><img src="assets/shoe3.jfif" alt="showimage" class="px-64 items-center"><h3 class="font-bold text-xl">Shoes</h3><p><b>This is 3rd Demo Show of Nike Brand</b></p><h5><b>Rs 11,500/- only</b></h5><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><br><button class="buy-3 border-2 px-2 border-black rounded-md">Buy Now</button></div></td><td class="p-2"><div class="content text-center"><img src="assets/shoe4.jfif" alt="showimage" class="px-64 items-center"><h3 class="font-bold text-xl">Shoes</h3><p><b>This is 4th Demo Show of Nike Brand</b></p><h5><b>Rs 13,200/- only</b></h5><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><i class="fa fa-star checked"></i><br><button class="buy-4 border-2 px-2 border-black rounded-md">Buy Now</button></div></td></tr></table></div></div>`)
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }" class="font-bold text-3xl p-2">Shopping Product List</h1><table><tr class="text-center"><td><label>Product Name :</label></td><td><input type="text"${
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${
    __vite_ssr_import_0__.ssrRenderAttrs(_attrs)
        ...
        Productlist Project
    </title><h1 class="text-center font-bold text-5xl mt-4">Form To Add Products</h1><hr class="mt-5 border-1 border-black"><div class="border-4 bg-gray-100 mr-60 ml-60 p-6 border-solid border-black rounded-md mt-6"><form action=""><div class="p-1"><label class="font-bold text-xl mr-16" for="pname">Product Name</label><input class="ml-16 border-2 px-32" type="text"${
    __vite_ssr_import_0__.ssrRenderAttr("value", $data.formdata.pname)
  } name="pname" id="pname"></div><div class="p-1"><label class="font-bold text-xl mr-16" for="price">Product Price</label><input class="ml-16 border-2 px-32" type="text"${
    __vite_ssr_import_0__.ssrRenderAttr("value", $data.formdata.price)
  ...
  _push(`<!--]--></table><div><label class="font-bold text-xl mr-16" for="searchpro">Serach Product</label><input class="ml-16 border-2 px-32" type="text" name="searchpro" id="searchpro"><button class="border-2 font-bold rounded-md bg-red-300 text-blue-500 hover:bg-black text-white p-2 text-center" type="search">Search</button></div></div></div>`)
}
